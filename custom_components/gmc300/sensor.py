...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([
        GMCSensor(hass, entry, SENSOR_TYPE_SUCCESS_RATE),
    ])
    if model_code in [GMCKettle.MODELS_4]: # RK-G2xxS, RK-M13xS, RK-M21xS, RK-M223S but not sure
        async_add_entities([
...
class GMCSensor(SensorEntity):
    """Representation of a GMC sensor device."""
